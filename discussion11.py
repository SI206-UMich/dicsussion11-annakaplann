...
def add_pets_from_json(filename, cur, conn):
    ...
    for item in json_data:
        ...
        cur.execute("INSERT INTO Patients (ped_id, name, species_id, age, cuteness, aggressiveness) VALUES (?, ?, ?, ?, ?, ?)", (ped_id, name, species_id, age, cuteness, aggressiveness))
        ped_id += 1
